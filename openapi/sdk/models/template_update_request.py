...
if TYPE_CHECKING:
    ...
    from ..models.template_update_request_env_vars import TemplateUpdateRequestEnvVars
...
class TemplateUpdateRequest:
    ...
    Attributes:
        ...
        env_vars (Union[Unset, TemplateUpdateRequestEnvVars]):
    ...
    env_vars: Union[Unset, "TemplateUpdateRequestEnvVars"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.deployment_source import DeploymentSource
        from ..models.template_update_request_env_vars import (
        ...
        if isinstance(_env_vars, Unset):
            ...
            env_vars = TemplateUpdateRequestEnvVars.from_dict(_env_vars)
