...
if TYPE_CHECKING:
    ...
    from ..models.template_create_request_env_vars import TemplateCreateRequestEnvVars
...
class TemplateCreateRequest:
    ...
    Attributes:
        ...
        env_vars (Union[Unset, TemplateCreateRequestEnvVars]):
    ...
    env_vars: Union[Unset, "TemplateCreateRequestEnvVars"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.deployment_source import DeploymentSource
        from ..models.template_create_request_env_vars import (
        ...
        if isinstance(_env_vars, Unset):
            ...
            env_vars = TemplateCreateRequestEnvVars.from_dict(_env_vars)
